package com.demo.fbAPI.messgenger.controller;
...
public class MessengerWebhookController {
    ...
    @Autowired
    public MessengerWebhookController(final Messenger messenger) {
    ...
    private void sendFileMessage(String recipientId) throws MessengerApiException, MessengerIOException, MalformedURLException {
        final UrlRichMediaAsset richMediaAsset = UrlRichMediaAsset.create(FILE, new URL("https://docs.google.com/spreadsheets/d/1ljc6SZYZHnWC54PsZe-daa0eTffEt5nbJVa23NRBkEE/edit?usp=sharing"));
        sendRichMediaMessage(recipientId, richMediaAsset);
    }
    ...
    private void handleSendException(Exception e) {
        logger.error("Không thể gửi tin nhắn. Đã xảy ra lỗi không mong muốn.", e);
    }
}
